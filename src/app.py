...
activities = {
    ...
    "Drama Club": {
        "description": "Theater production and acting skills",
    ...
    "Swimming Team": {
        ...
        "max_participants": 20,
        "participants": ["megan@mergington.edu", "kevin@mergington.edu"]
    },
    "Soccer Club": {
...
def unregister_from_activity(activity_name: str, email: str):
    ...
    # Remove all occurrences to keep participant list clean if duplicates exist
